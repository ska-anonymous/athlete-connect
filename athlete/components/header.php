            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="../uploads/profile_pics/<?php echo $_SESSION['athlete']['profile_picture']; ?>"
                            class="user-image img-circle elevation-2" alt="Profile Image">
                        <span class="d-none d-md-inline">
                            <?php echo $_SESSION['athlete']['first_name']; ?>
                        </span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-header bg-primary">
                            ...
                            <p>
                                <?php echo $_SESSION['athlete']['first_name'] . " " . $_SESSION['athlete']['last_name']; ?>
                                <?php
                                $user_creation_timestring = $_SESSION['athlete']['created_at'];
