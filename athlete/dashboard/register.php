...
<head>
  ...
  <title>AthleteConnect | Athlete Register</title>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="input-group mb-3">
                <input type="text" maxlength="50" class="form-control" name="first_name" placeholder="First Name"
                  required>
              ...
              <div class="input-group mb-3">
                <input type="text" maxlength="50" name="login_id" class="form-control" placeholder="Login id" required>
                <div class="input-group-append">
                  <div class="input-group-text">
              ...
              <div class="input-group mb-3">
                ...
                <input type="radio" id="male" name="gender" value="Male" class="form-control" placeholder="Gender"
                  required>
                <label for="female">Female</label>
                <input type="radio" id="female" name="gender" value="Female" class="form-control" placeholder="Gender"
                  required>
                <label for="others">Others</label>
                <input type="radio" id="others" name="gender" value="Others" class="form-control" placeholder="Gender"
                  required>
                <div class="input-group-append">
                  <div class="input-group-text">
                    Gender
            ...
            <div class="col-md-4">
              <div class="input-group mb-3">
                <input type="text" maxlength="30" name="nationality" class="form-control" placeholder="Nationality"
                  required>
                <div class="input-group-append">
                  <div class="input-group-text">
              ...
              <div class="input-group mb-3">
                <input type="text" maxlength="200" name="address" class="form-control" placeholder="Address" required>
                <div class="input-group-append">
                  <div class="input-group-text">
              ...
              <div class="input-group mb-3">
                <input type="text" maxlength="50" name="city" class="form-control" placeholder="City" required>
                <div class="input-group-append">
                  <div class="input-group-text">
              ...
              <div class="input-group mb-3">
                <input type="text" maxlength="50" name="country" class="form-control" placeholder="Country" required>
                <div class="input-group-append">
                  <div class="input-group-text">
              ...
              <div class="input-group mb-3">
                <input type="number" min="0" step="any" name="height" class="form-control" placeholder="Height (inches)"
                  required>
                <div class="input-group-append">
                  <div class="input-group-text">
              ...
              <div class="input-group mb-3">
                <input type="number" min="0" step="any" name="weight" class="form-control" placeholder="Weight (kg)"
                  required>
                <div class="input-group-append">
                  <div class="input-group-text">
              ...
              <div class="input-group mb-3">
                <input type="text" name="primary_sport" maxlength="50" class="form-control" placeholder="Primary Sport"
                  required>
                <div class="input-group-append">
                  <div class="input-group-text">
              ...
              <div class="input-group mb-3">
                <input type="text" name="secondary_sports" maxlength="200" class="form-control"
                  placeholder="Secondary Sport(s)">
                <div class="input-group-append">
                  <div class="input-group-text">
                    <span class="fas fa-running"></span>
                  </div>
            ...
            <div class="col-md-4">
              <div class="input-group mb-3">
                <input type="text" name="education_level" maxlength="100" class="form-control"
              ...
              <div class="input-group mb-3">
                <input type="file" accept="image/*" multiple name="sport_pictures[]" class="form-control"
                  placeholder="Sports Pictures" required>
                <div class="input-group-append">
                  <div class="input-group-text">
                    Sport Pics (3 pics)
                  </div>
              ...
              <div class="form-group mb-3">
                <textarea type="text" name="awards" class="form-control" maxlength="500"
                  placeholder="Awards/Honor"></textarea>
              </div>
              <div class="form-group mb-3">
                <textarea type="text" name="athletic_achievements" maxlength="500" class="form-control"
                  placeholder="Athletic Achievements"></textarea>
