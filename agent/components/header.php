    ...
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="../uploads/profile_pics/<?php echo $_SESSION['agent']['profile_picture']; ?>"
                            class="user-image img-circle elevation-2" alt="User Image">
                        <span class="d-none d-md-inline">
                            <?php echo $_SESSION['agent']['first_name']; ?>
                        </span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-header bg-primary">
                            ...
                            <p>
                                <?php echo $_SESSION['agent']['first_name'] . " " . $_SESSION['agent']['last_name']; ?>
                                <?php
                                $user_creation_timestring = $_SESSION['agent']['created_at'];
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                <img src="../../dist/img/athlete-logo.png" alt="Athlete Logo" class="brand-image img-circle"
                    style="filter:invert(1);">
                <span class="brand-text font-weight-light">Athlete Connect</span>
            </a>
            ...
            <div class="sidebar mt-2">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="athletes_list.php" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="offers_sent.php" class="nav-link">
